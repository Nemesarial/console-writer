...
('')
('                      ZA CENTRAL REGISTRY NPC (ZACR).')
('                        COZA Registration Office')
('                      Last Change - 19 January 2015')
('')
('               APPLICATION TO ESTABLISH A SUB-DOMAIN WITHIN')
('                    THE .CO.ZA NAMESPACE OF THE INTERNET.')
('')
('     ===================================================================')
('     |The ZACR has administered the \'.CO.ZA.\' namespace as from        |')
...
('     |or contact ZACR\'s office, the details of which are               |')
...
('     |ZACR, the designated Billing Contact (line 2f) hereby            |')
...
('    delegated by ZACR. are at the third level, for example:')
